...
void move_a_to_b(t_stack_node **stack_a, t_stack_node **stack_b)
{
    ...
    if (cheapest_node->above_medium && cheapest_node->target_node && cheapest_node->target_node->above_medium)
        rotate_both_stacks(stack_a, stack_b, cheapest_node);
    else if (!cheapest_node->above_medium && cheapest_node->target_node && !cheapest_node->target_node->above_medium)
